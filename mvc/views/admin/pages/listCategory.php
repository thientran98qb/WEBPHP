		...
		<section class="content">
			...
			<div class="card">
				<div class="card-header">
					...
					<div>
						<!-- Modal -->
						<p><a href="<?=BASE_URL?>/Admin/formAddCategory" class="btn btn-primary">Add Category</a></p>
					</div>
				</div>
					...
					<table class="table table-striped projects">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<?php echo $category['unsigned_category_name']; ?>
								</td>
								<td>
									<img  src="<?=BASE_URL?>/public/img/<?php echo $category['image']; ?>" height="100px" width="100px">
								</td>
								<td class="project-actions text-left">
									<a href="<?=BASE_URL?>/Admin/editFormCate&id_category=<?php echo $category['id_category']; ?>" class="btn btn-primary btn-sm">Edit</a>
									<form action="<?=BASE_URL?>/Admin/deleCate" method="post" style="float: left;">
