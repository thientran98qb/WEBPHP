        ...
        <div class="card-header">
          ...
          <div>
            <?php $mangVege=$data['vegetable']; ?>
              ...
              ?>
            <form action="<?=BASE_URL?>/Admin/editSeaFood" method="POST">
              <input type="hidden" name="idVe" value="<?php echo $veg['id_seafood']; ?>">
              <div class="form-group">
                <label for="ct">
                  Spice Name
                </label>
                <input type="text" name="nameVe" value="<?php echo $veg['name_seafood'];  ?>" class="form-control">
              </div>
              <div class="form-group">
                <label for="uct">
                  Price
